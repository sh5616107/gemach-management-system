...
- [ ] 1. הוספת מבני נתונים ומתודות Database
...
- [ ] 3. יצירת מודל העברה לערבים (LoanTransferModal)
...
- [ ] 3.7 אינטגרציה של LoanTransferModal ב-OverdueLoansPage
...
- [ ] 4. הצגת חובות ערבים בדף הלוואות
- [ ] 4.1 צור קומפוננטה GuarantorDebtCard
...
- [ ] 5. סימון הלוואות מועברות בדף הלווה
- [ ] 5.1 עדכן תצוגת הלוואות ב-LoansPage
...
- [ ] 6. ניהול רשימה שחורה אוטומטי
- [ ] 6.1 מימוש הוספה אוטומטית של לווה לרשימה שחורה
...
- [ ] 6.4 אינטגרציה של בדיקות תקופתיות
...
- [ ] 7.3 אינטגרציה בדף סטטיסטיקות
  - הוסף סקציה "הלוואות מועברות לערבים"
  - הצג: מספר הלוואות מועברות, סכום כולל, מספר ערבים מעורבים
  - גרפים ותרשימים
  - _דרישות: 9.4_

- [ ] 7.4 הוסף אפשרות ייצוא דוחות
  - כפתור ייצוא ל-Excel/PDF
  - בחירת טווח תאריכים
  - בחירת שדות לייצוא
  - _דרישות: 9.5_

- [ ] 8. בדיקות ותיקונים סופיים
- [ ] 8.1 בדוק תהליך העברה מלא מקצה לקצה
...
- [ ] 9. תיעוד ומדריך משתמש
- [ ] 9.1 כתוב הערות קוד מפורטות
