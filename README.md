...
- **🚀 מצב ביצועים:** (חדש! 🆕)
  - **מצב רגיל** - כולל אנימציות רקע, אפקטי hover מתקדמים, blur, זוהר ועוד
  - **מצב קל** - ללא אנימציות ואפקטים כבדים - מומלץ מאוד למחשבים חלשים ולשימוש באלקטרון
  - ⚡ מצב קל משפר ביצועים ב-50-70% במחשבים חלשים
  - ⚠️ המערכת תרענן אוטומטית אחרי שינוי המצב
...
- **🚀 מצב ביצועים משופר** - שתי גרסאות עיצוב
  - **מצב רגיל** - עם כל האנימציות והאפקטים הויזואליים
  - **מצב קל** - ללא אנימציות כבדות, מיועד למחשבים חלשים
  - שיפור ביצועים של 50-70% במצב קל
  - מקל משמעותית על השימוש באלקטרון
...
- **אופטימיזציה לאלקטרון** - הסרת אפקטים כבדים במצב קל
...
- 🆕 **🚀 מצב ביצועים משופר** - שתי גרסאות עיצוב (רגיל/קל) לשיפור ביצועים באלקטרון
