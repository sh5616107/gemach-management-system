            ...
            <div className="container">
                <div className="form-container">
                    ...
                    <div style={{ background: '#e8f5e8', padding: '15px', borderRadius: '8px', margin: '20px 0', textAlign: 'center', border: '2px solid #27ae60' }}>
                        <h3 style={{ color: '#27ae60', margin: '0 0 10px 0' }}>🆕 גרסה 2.9.57</h3>
                    ...
                    <div style={{ textAlign: 'right', lineHeight: '1.8', fontSize: '16px' }}>
                        ...
                        <section style={{ marginBottom: '30px' }}>
                            <h3 style={{ color: '#3498db', borderBottom: '2px solid #3498db', paddingBottom: '10px' }}>
                                🏦 מערכת מס"ב (גביית תשלומים אוטומטית)
                            </h3>
                            <div style={{ background: '#e8f4fd', padding: '15px', borderRadius: '8px', margin: '10px 0' }}>
                                <h4>מהי מערכת מס"ב?</h4>
                                <p>מערכת לגביית תשלומים אוטומטית מחשבונות בנק של לווים. מתאימה לגמ"חים גדולים עם הסכמים עם בנקים.</p>

                                <h4>הפעלת המערכת:</h4>
                                <ol>
                                    <li>עבור להגדרות → "פונקציות מתקדמות"</li>
                                    <li>הפעל "מערכת מס"ב"</li>
                                    <li>הזן את פרטי המוסד (קוד מוסד, מספר שולח, שם מוסד)</li>
                                    <li>הפרטים יתקבלו מהבנק או מחברת הסליקה</li>
                                </ol>

                                <h4>יצירת קובץ מס"ב:</h4>
                                <ul>
                                    <li>לחץ על "מס"ב" בדף הבית</li>
                                    <li>בחר "יצירת קובץ מס"ב חדש"</li>
                                    <li>בחר הלוואות לגביה (רק הלוואות עם פרטי בנק)</li>
                                    <li>הקובץ ייווצר בפורמט הנדרש לבנקים</li>
                                    <li>העלה את הקובץ למערכת הבנק</li>
                                </ul>

                                <h4>מעקב אחר קבצים:</h4>
                                <ul>
                                    <li>כל קובץ מקבל מספר ייחודי</li>
                                    <li>ניתן לצפות בהיסטוריית קבצים</li>
                                    <li>בדיקת תקינות קבצים לפני העלאה</li>
                                </ul>
                            </div>
                        </section>
                        ...
                        <section style={{ marginBottom: '30px' }}>
                            <h3 style={{ color: '#e67e22', borderBottom: '2px solid #e67e22', paddingBottom: '10px' }}>
                                👥 העברת הלוואות לערבים
                            </h3>
                            <div style={{ background: '#fef9e7', padding: '15px', borderRadius: '8px', margin: '10px 0' }}>
                                <h4>מתי להשתמש?</h4>
                                <p>כאשר לווה לא מחזיר הלוואה, ניתן להעביר את החוב לערבים שלו.</p>

                                <h4>איך זה עובד:</h4>
                                <ol>
                                    <li>בחר הלוואה עם ערבים</li>
                                    <li>לחץ "העבר לערבים"</li>
                                    <li>בחר לאיזה ערב להעביר (ערב 1, ערב 2, או שניהם)</li>
                                    <li>הזן סכום להעברה</li>
                                    <li>ההלוואה המקורית תסומן כ"הועברה לערבים"</li>
                                    <li>תיווצר הלוואה חדשה על שם הערב</li>
                                </ol>

                                <h4>דוחות ערבים:</h4>
                                <ul>
                                    <li><strong>דוח חובות ערבים:</strong> רשימת כל הערבים עם החובות שלהם</li>
                                    <li><strong>דוח הלוואות מועברות:</strong> היסטוריה של כל ההעברות</li>
                                    <li>גישה מהירה מדף הבית → "דוחות ערבים"</li>
                                </ul>
                            </div>
                        </section>
                        ...
                        <section style={{ marginBottom: '30px' }}>
                            ...
                            <div style={{ background: '#f4f0ff', padding: '15px', borderRadius: '8px', margin: '10px 0' }}>
                                <h4>הגדרת סיסמה למערכת:</h4>
                                <ol>
                                    <li>עבור להגדרות → "הגדרות אבטחה"</li>
                                    <li>לחץ "הגדר סיסמה"</li>
                                    <li>הזן סיסמה (לפחות 4 תווים)</li>
                                    <li>הסיסמה תידרש בכל כניסה למערכת</li>
                                </ol>

                                <h4>שכחת סיסמה?</h4>
                                <ul>
                                    <li>לחץ "שכחתי את הסיסמה" בדף ההתחברות</li>
                                    <li>פנה למפתח התוכנה עם התאריך הנוכחי</li>
                                    <li>תקבל קוד שחזור בן 6 ספרות</li>
                                    <li>הזן את הקוד לאיפוס הסיסמה</li>
                                    <li>📧 מייל תמיכה: sh5616107@gmail.com</li>
                                </ul>

                                <h4>צפייה בסיסמה נוכחית:</h4>
                                <ul>
                                    <li>בהגדרות → "הגדרות אבטחה"</li>
                                    <li>לחץ על כפתור העין (👁️) ליד "סיסמה נוכחית"</li>
                                    <li>הסיסמה תוצג לזמן קצר</li>
                                </ul>
                            </div>
                        </section>
                        ...
                        <section style={{ marginBottom: '30px' }}>
                            <h3 style={{ color: '#27ae60', borderBottom: '2px solid #27ae60', paddingBottom: '10px' }}>
                                ⏰ תאריך פירעון אוטומטי
                            </h3>
                            <div style={{ background: '#f0fff4', padding: '15px', borderRadius: '8px', margin: '10px 0' }}>
                                <h4>חישוב אוטומטי:</h4>
                                <p>המערכת מחשבת אוטומטית את תאריך הפירעון לפי ההגדרות:</p>
                                <ul>
                                    <li>עבור להגדרות → "תקופת הלוואה ברירת מחדל"</li>
                                    <li>הגדר כמה חודשים (למשל: 12 חודשים)</li>
                                    <li>בהלוואה חדשה - תאריך הפירעון יחושב אוטומטית</li>
                                    <li>כשמשנים תאריך הלוואה - תאריך הפירעון מתעדכן</li>
                                </ul>

                                <h4>דוגמה:</h4>
                                <div style={{ background: '#fff', padding: '10px', border: '1px solid #ddd', borderRadius: '5px', fontFamily: 'monospace' }}>
                                    תקופה: 12 חודשים<br />
                                    תאריך הלוואה: 15.11.2025<br />
                                    תאריך פירעון: 15.11.2026 (אוטומטי)
                                </div>
                            </div>
                        </section>
                        ...
                        <section style={{ marginBottom: '30px' }}>
                            ...
                            <div style={{ background: '#fdf6e3', padding: '15px', borderRadius: '8px', margin: '10px 0' }}>
                                <ul>
                                    <li>הנתונים נשמרים מקומית במחשב</li>
                                    <li>אין שליחת מידע לאינטרנט</li>
                                    <li>גבה נתונים חשובים במקום בטוח (ייצוא/ייבוא)</li>
                                    <li>השתמש במחשב מאובטח עם סיסמה</li>
                                    <li>הגדר סיסמה למערכת להגנה נוספת</li>
                                </ul>
                            </div>
                        </section>
